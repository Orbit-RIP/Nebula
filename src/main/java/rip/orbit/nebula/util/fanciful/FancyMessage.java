package rip.orbit.nebula.util.fanciful;
...
import static rip.orbit.nebula.util.fanciful.TextualComponent.rawText;
 ...
 * and a call to {@link #then()} or {@link #then(String)} will append a new kits component to the end of the message,
...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	 ...
	 *
	 * @param text The new text of the current kits component.
	 ...
	 *
	 * @param color The new color of the current kits component.
	 * @return This builder instance.
	 ...
	 * The client <b>will</b> immediately send the command to the server to be executed when the kits component is clicked.
	 *
	 * @param command The text to display in the chat bar of the client.
	 * @return This builder instance.
	 */
	 ...
	 * @return This builder instance.
	 */   /* ------------
	public FancyMessage translationReplacements(Iterable<? extends CharSequence> replacements){
	...
	*/
	...
	/**
	 * Terminate construction of the current kits component, and begin construction of a new message component.
