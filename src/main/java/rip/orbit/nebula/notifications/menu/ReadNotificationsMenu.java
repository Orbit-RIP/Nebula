...
@AllArgsConstructor
public class ReadNotificationsMenu extends Menu {
	...
	public ReadNotificationsMenu(UUID uuid, boolean backButton) {
		this.uuid = uuid;
	...
	public Map<Integer, Button> getButtons(Player player) {
		...
		buttons.put(4, new ViewAllNotificationsButton(backButton));
