package cc.fyre.neutron.profile.menu.button;
 ...
 * 02/02/2022 / 8:02 PM
 * Orbit Dev / cc.fyre.neutron.profile.menu.button
 */
...
public class ProfileViewButton extends Button {
	...
	public List<String> getDescription(Player var1) {
		...
		Profile profile = Neutron.getInstance().getProfileHandler().fromUuid(this.uuid);
