...
public abstract class TextualComponent implements Cloneable {
	...
	private static class ArbitraryTextTypeComponent extends TextualComponent implements ConfigurationSerializable {
		...
		public TextualComponent clone() throws CloneNotSupportedException {
			// Since this is a private and class, we can just reinstantiate this class instead of casting super.clone
	...
	/**
	 * Create a textual component representing a me.joeleoli.practice.scoreboard value.
	 ...
	 * @return The text component representing the specified me.joeleoli.practice.scoreboard score (for the viewing player), or {@code null} if an error occurs during JSON serialization.
	 */
	 ...
	 * @param scoreboardObjective The name of the objective for which to display the score.
	 * @return The text component representing the specified me.joeleoli.practice.scoreboard score for the specified player, or {@code null} if an error occurs during JSON serialization.
	 */
