...
public class Profile {
    ...
    public void refreshDisplayName(Player player) {
        ...
        if (this.getServerProfile().isVIPStatus() && !this.getActiveGrant().getRank().getName().equals("VIP")) {
            displayName = Nebula.getInstance().getRankHandler().fromName("VIP").getPrefix().replaceAll("&h", this.getServerProfile().getVipStatusColor().toString()) + activeGrant.getRank().getColor() + player.getName();
